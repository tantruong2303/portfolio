...
var Navbar = function Navbar() {
  ...
  return __jsx("div", {
    ...
    className: "text-2xl text-bombay-500 ".concat(isActive ? 'fade-in' : 'opacity-0'),
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 49,
