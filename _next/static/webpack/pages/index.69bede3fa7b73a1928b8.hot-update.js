...
var Home = function Home() {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, __jsx(_components_seoHead__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    className: "flex flex-col justify-center px-4 py-16 space-y-4 bg-white md:items-center md:px-24 md:space-x-96 md:flex-row",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30,
