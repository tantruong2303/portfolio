...
const Service: React.FunctionComponent<ServiceProps> = () => {
    return (
        <div className="px-4 py-16 md:w-4/5 md:mx-auto ">
            <div className="mx-auto space-y-8 ">
                <div className="">
                    <h1 className="text-xl font-semibold text-gray-500">SERVICES</h1>
                    <div className="h-2 bg-gray-400 bg-opacity-30"></div>
                </div>
                <div className="flex flex-col justify-center space-y-4 md:space-x-16 md:flex-row md:space-y-0 ">
                    <div className="flex flex-col items-center justify-center max-w-xl p-8 space-y-4 text-center text-white shadow-lg bg-woodsmoke-500">
                        <ServiceLogo />
