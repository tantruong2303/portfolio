...
var Navbar = function Navbar() {
  ...
  return __jsx("div", {
    ...
    className: "fixed top-0 left-0 z-40 w-full h-full p-4 pt-32 bg-opacity-75 bg-shark-400 transform duration-300 ".concat(isActive ? 'translate-x-full' : 'translate-x-0'),
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44,
